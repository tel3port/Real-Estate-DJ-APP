...
with open(os.getcwd()+"/gallery/dict/kw_list.txt") as kw_file:
    global kws
...
def home(request):
    ...
    title = random_kw
    keywords = kws[randint(0, len(kws) - 1)]+" , "+kws[randint(0, len(kws) - 1)]+" , "+kws[randint(0, len(kws) - 1)]+" , "+kws[randint(0, len(kws) - 1)]+" , "+kws[randint(0, len(kws) - 1)]+" , "
    content = ""
